...
**Canonical Raw Transaction Example:**

This raw transaction is used as the standard test vector for chunking, encoding, and decoding in both `btcmesh-cli.py` and server-side tests. All chunking/decoding logic should be validated against this example.
